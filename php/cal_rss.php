...
//	$rss = "http://webcal.malone.edu:9090/webcache/v1.0/rssRange/".$today."/".$later."/list-rss/%28catuid%3D%27402849b7-".$feed."%27%29.rss";
	if($rss == null){
		$rss = "http://webcal.malone.edu:9090/webcache/v1.0/rssDays/31/list-rss/no--filter.rss";
	}
$rssitems=2;
$grabXML=$rss;
